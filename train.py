...
def train(env, agent):
    file_writer = get_file_writer(model_name=model_name)
...
if __name__ == '__main__':
    ...
    training_agent = ActorCritic(training_steps=n_steps, learning_rate=learning_rate,
